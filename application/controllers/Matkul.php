...
class Matkul extends CI_Controller
{
	...
	public function index()
	{
		$data = [
			...
			'judul'	=> 'Organisasi Unit',
			'subjudul' => 'Data Organisasi Unit'
		];
	...
	public function add()
	{
		$data = [
			'user' 		=> $this->ion_auth->user()->row(),
			'judul'		=> 'Tambah Organisasi Unit',
			'subjudul'	=> 'Tambah Data Organisasi Unit',
	...
	public function edit()
	{
		...
		if (!$chk) {
			...
			$data = [
				'user' 		=> $this->ion_auth->user()->row(),
				'judul'		=> 'Edit Organisasi Unit',
				'subjudul'	=> 'Edit Data Organisasi Unit',
				'matkul'	=> $matkul
			];
			$this->load->view('_templates/dashboard/_header.php', $data);
	...
	public function import($import_data = null)
	{
		$data = [
			'user' => $this->ion_auth->user()->row(),
			'judul'	=> 'Organisasi Unit',
			'subjudul' => 'Import Organisasi Unit'
		];
