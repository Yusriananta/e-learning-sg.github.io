...
class Jurusan extends CI_Controller
{
	...
	public function add()
	{
		$data = [
			'user' 		=> $this->ion_auth->user()->row(),
			'judul'		=> 'Tambah Tipe Pegawai',
			'subjudul'	=> 'Tambah Data Tipe Pegawai',
	...
	public function edit()
	{
		...
		if (!$chk) {
			...
			$data = [
				'user' 		=> $this->ion_auth->user()->row(),
				'judul'		=> 'Edit Tipe Pegawai',
				'subjudul'	=> 'Edit Data Tipe Pegawai',
				'jurusan'	=> $jurusan
			];
			$this->load->view('_templates/dashboard/_header', $data);
